 ...
 * -----
 * Last Modified: Monday, 24th April 2023 5:00:58 pm
...
const Login: FC = () => {
  ...
  const loginHandler = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    resetLoginStates();
    const redirectPath = (location.state as ILocationState)?.path || RoutePaths.Root;
    ...
    >
      <CustomPaper>
        ...
        >
          ...
          {import.meta.env.DEV && <Typography variant='body2'>App Version {version}</Typography>}
        </Box>
      </CustomPaper>
    </Container>
  );
